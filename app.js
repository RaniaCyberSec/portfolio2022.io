...
.pauseFor(1800)
.changeDelay(20)
.typeString('Moi c\'est Ghania Bourdais')

.pauseFor(1000)
.typeString('<strong>, Expert en systèmes d\'information</strong> !')

.pauseFor(300)
.typeString('<strong>, Consultante Cybersécurité</strong> !')

.pauseFor(1000)
.deleteChars(15)
.typeString('<span style="color: #27ae60;">Forensic</span> !')

.pauseFor(1000)
.deleteChars(10)
.typeString('<span style="color: #EA39ff;"> Pentesting</span> !<br>')
...
.pauseFor(1000)
.deleteChars(5)
.typeString('<span style="color: #adcf17;"> React</span> !')
.pauseFor(1000)
.deleteChars(7)
.typeString('<span style="color: #aa1e87;"> Java</span> !')
.pauseFor(1000)
.deleteChars(10)
.typeString('<span style="color: #0878f0;"> Wordpress</span> !')
.pauseFor(1000)
.deleteChars(12)
